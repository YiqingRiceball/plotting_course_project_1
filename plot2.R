...
##Add and Save Plot
#Create a png file called plot2 that is 480-pixel wide and 480-pixel high
#in current working directory
png(filename = "/Users/defaultuser/Desktop/Exploratory Data Analysis/course project 1/graphics/plot2.png",
    width = 480, 
    height = 480)
